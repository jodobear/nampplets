...
public enum NappletVocabulary {
    ...
    /// - Parameter fallbackTitle: ignored for unrecognised domains. A
    ///   projected or derived title is evidence, not trusted vocabulary.
    ...
    private static func unrecognised(
        ...
        return NappletCapabilityPhrase(
            "Use an unrecognised capability",
            "This app has no trusted description for “\(domain)”. Its "
                + "authority is unknown. Allow it only if you trust the "
                + "publisher.",
    ...
    private static let known: [String: NappletCapabilityPhrase] = [
        ...
        "media": NappletCapabilityPhrase(
            ...
            "It has to ask this device for permission first, and you'll see "
                + "the usual recording indicator whenever it does.",
            symbol: "camera"
        ),
        ...
        "notify": NappletCapabilityPhrase(
            ...
            "The same notifications any app sends. You can turn them off in "
                + "this device's settings at any time.",
            symbol: "bell"
        ),
        ...
        "serial": NappletCapabilityPhrase(
            "Talk to a connected serial device",
            "Hardware connected over a serial link, such as a development "
                + "board or signing device.",
